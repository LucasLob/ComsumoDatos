...
<html>
    ...
    <div class ="delete">   
        <form name="eliminar">
            <h3 class = "title">¿Que Consulta Quieres Eliminar?</h3>
              <p>Titulo Del Deseo</p><input type = "text" id ="jax" name="title">
              <p id="mensaje" style="color: white;"></p>
              <table>
                 
                  <td><input type="reset" value="Limpiar" class ="uno"></td><td><button type="button" class ="uno" id="eliminar">Eliminar Consulta</button></td>
              </table>
        </form>     
    </div>  
    </center>
